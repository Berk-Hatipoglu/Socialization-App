...
import appbackend.exception.BadRequestException;
import appbackend.exception.ResourceNotFoundException;
import appbackend.model.*;
import appbackend.payload.PagedResponse;
import appbackend.payload.PollRequest;
import appbackend.payload.PollResponse;
import appbackend.payload.VoteRequest;
import appbackend.repository.PollRepository;
import appbackend.repository.UserRepository;
import appbackend.repository.VoteRepository;
import appbackend.security.UserPrincipal;
import appbackend.util.AppConstants;
import appbackend.util.ModelMapper;
